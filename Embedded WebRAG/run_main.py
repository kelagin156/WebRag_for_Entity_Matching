...
class WebRAGEntityMatcher:
    ...
    def search_with_tavily(self, title, mex_results):
        ...
        # Log the prompt and response to a file
        with open("tavily.txt", "a", encoding="utf-8") as file:
    ...
    # Method to perform entity matching with WebRAG using Tavily for context enrichment
    def webRag_entity_match(self, entity_1, entity_2, title1, title2):
        ...
        for n in [1, 3, 5]:
            ...
            # Embedd results for each entity separately
